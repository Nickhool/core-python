...
from ch06_DB.ushuffle_db import DBNAME, NAMELEN, randName,\
    FIELDS, tformat, cformat, setup

DSNs = {
    'mysql': 'mysql://root:123456@localhost/%s' % DBNAME,
    'sqlite': 'sqlite:///ushuffle_so.sqlite3',
    'postgresql': "host='localhost' dbname='test' user='nodeuz' password='123456'",
}
...
class SQLObjectTest(object):
    def __init__(self, dsn):
        ...
        try:
            ...
            cxn.qurey("CREATE DATABASE %s" % DBNAME)
            cxn = connectionForURI(dsn)
